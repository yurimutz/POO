...
public class Voto{
    ...
    public static void imprimeTotalVotos(){
        System.out.println("Total de votos: " + Voto.getQtd_votos());
    }

    public void imprimeVoto() throws Exception{
        System.out.println("Data do voto: " + this.getData());
        System.out.println("Titulo do eleitor: " + this.getEleitor().getTitulo());
        this.getCandidato().imprimeNome_RazaoSocial();
    }
